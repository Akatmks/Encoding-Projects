...
function prepare
    ...
    av1an -y --max-tries 10 --temp $temp_dir --verbose --log-level debug -i $source_file --sc-only --scenes $scenes_file --split-method none --extra-split 360 --min-scene-len 6 --encoder svt-av1 --zones $zones_file
