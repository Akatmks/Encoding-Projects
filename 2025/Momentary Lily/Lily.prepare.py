            ...
            for fno, frame in enumerate(collect.frames(close=True)):
                ...
                if fno >= scenes["scenes"][scenes_head]["end_frame"] - 1:
                    ...
                    if strong_noise_scene_average < 0.03 and weak_noise_scene_average < 0.06:
                        zones.write(f"{scenes["scenes"][scenes_head]["start_frame"]} {scenes["scenes"][scenes_head]["end_frame"]} svt-av1 reset --lp 5 --keyint -1 --lookahead 120 --input-depth 10 --preset 1 --tune 3 --rc 0 --aq-mode 2 --crf 21.5 --qm-min 8 --sharpness 1 --film-grain 0 --enable-variance-boost 1 --variance-boost-strength 3 --variance-octile 4 --enable-tf 2 --enable-dlf 1 --enable-cdef 1 --enable-restoration 1 --psy-rd 1.0 --spy-rd 1 --color-primaries 1 --transfer-characteristics 1 --matrix-coefficients 1 --color-range 0\n")
                    # Weak boost
                    elif strong_noise_scene_average < 0.05 and weak_noise_scene_average < 0.11:
                        zones.write(f"{scenes["scenes"][scenes_head]["start_frame"]} {scenes["scenes"][scenes_head]["end_frame"]} svt-av1 reset --lp 5 --keyint -1 --lookahead 120 --input-depth 10 --preset 1 --tune 3 --rc 0 --aq-mode 2 --crf 27 --qm-min 8 --sharpness 0 --film-grain 2 --film-grain-denoise 0 --enable-variance-boost 1 --variance-boost-strength 1 --variance-octile 6 --enable-tf 2 --enable-dlf 1 --enable-cdef 1 --enable-restoration 1 --psy-rd 1.3 --spy-rd 1 --color-primaries 1 --transfer-characteristics 1 --matrix-coefficients 1 --color-range 0\n")
                    # Actually a drop
                    else:
                        zones.write(f"{scenes["scenes"][scenes_head]["start_frame"]} {scenes["scenes"][scenes_head]["end_frame"]} svt-av1 reset --lp 5 --keyint -1 --lookahead 120 --input-depth 10 --preset 1 --tune 3 --rc 0 --aq-mode 2 --crf 30 --qm-min 8 --sharpness 1 --film-grain 2 --film-grain-denoise 0 --enable-variance-boost 0 --enable-tf 2 --enable-dlf 1 --enable-cdef 1 --enable-restoration 1 --psy-rd 1.9 --spy-rd 1 --color-primaries 1 --transfer-characteristics 1 --matrix-coefficients 1 --color-range 0\n")
