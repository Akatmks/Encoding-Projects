            ...
            for fno, frame in enumerate(collect.frames(close=True)):
                ...
                if fno >= scenes["scenes"][scenes_head]["end_frame"] - 1:
                    ...
                    # Weak boost
                        ...
                        if frame_diff_scene_average >= 0.08:
                            zones.write(f"{scenes["scenes"][scenes_head]["start_frame"]} {scenes["scenes"][scenes_head]["end_frame"]} svt-av1 reset --lp 4 --keyint -1 --lookahead 120 --input-depth 10 --preset 0 --tune 3 --rc 0 --aq-mode 2 --crf 27.5 --qm-min 8 --sharpness 0 --film-grain 2 --film-grain-denoise 0 --enable-variance-boost 1 --variance-boost-strength 1 --variance-octile 6 --psy-rd 1.3 --spy-rd 1 --color-primaries 1 --transfer-characteristics 1 --matrix-coefficients 1 --color-range 0\n")
                        else:
                            zones.write(f"{scenes["scenes"][scenes_head]["start_frame"]} {scenes["scenes"][scenes_head]["end_frame"]} svt-av1 reset --lp 4 --keyint -1 --lookahead 120 --input-depth 10 --preset 1 --tune 3 --rc 0 --aq-mode 2 --crf 27 --qm-min 8 --sharpness 0 --film-grain 2 --film-grain-denoise 0 --enable-variance-boost 1 --variance-boost-strength 1 --variance-octile 6 --psy-rd 1.3 --spy-rd 1 --color-primaries 1 --transfer-characteristics 1 --matrix-coefficients 1 --color-range 0\n")
                    # Actually a drop
                    else:
                        if frame_diff_scene_average >= 0.08:
                            zones.write(f"{scenes["scenes"][scenes_head]["start_frame"]} {scenes["scenes"][scenes_head]["end_frame"]} svt-av1 reset --lp 4 --keyint -1 --lookahead 120 --input-depth 10 --preset 0 --tune 3 --rc 0 --aq-mode 2 --crf 30 --qm-min 8 --sharpness 1 --film-grain 3 --film-grain-denoise 0 --enable-variance-boost 0 --psy-rd 1.8 --spy-rd 1 --color-primaries 1 --transfer-characteristics 1 --matrix-coefficients 1 --color-range 0\n")
                        else:
